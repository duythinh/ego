...
<div id="dashboard">
    ...
    <div class="row-fluid">
        <div class="span12 responsive">
            <?php if (! isset($transportation_type)): ?>
            ...
            <div class="alert alert-block alert-error fade in">
                ...
                <p class="pull-right">
                    <a class="btn green" href="<?php echo site_url('transportation/transportation_type/add'); ?>"><?php echo $this->lang->line('add_new_transportation_type'); ?></a>
                    <a class="btn blue" href="<?php echo site_url('transportation/transportation_type'); ?>"><?php echo $this->lang->line('manager'); ?></a>
                </p>
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <form id="add_new_transportation" action="" method="post" class="form-horizontal">
                        <input type="hidden" name="id" value="<?php echo $transportation_type['id']; ?>" />
                        ...
                        <div class="control-group<?php echo (form_error('alias') ? ' error' : ''); ?>">
                            ...
                            <div class="controls input-icon">
                                <input type="text" name="alias" class="span6 m-wrap" value="<?php echo set_value('alias', $transportation_type['alias']); ?>" />
                            ...
                            <div class="controls">
                                <div class="tabbable tabbable-custom">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li<?php echo ($this->session->get('language')->id == $language->id ? ' class="active"' : null); ?>><a href="#tab_transportation_type_name_<?php echo $language->code; ?>" data-toggle="tab"><i class="icon-picture"></i> <?php echo $language->name; ?></a></li>
                                        <?php endforeach; ?>
                                    </ul>

                                    <div class="tab-content">
                                        <?php foreach ($this->lang->get('translable') as $language): ?>
                                        <div class="tab-pane<?php echo ($this->session->get('language')->id == $language->id ? ' active' : null); ?>" id="tab_transportation_type_name_<?php echo $language->code; ?>">
                                            <input type="text" name="name[<?php echo $language->code; ?>]" class="span6 m-wrap" value="<?php echo set_value('name[' . $language->code . ']', $transportation_type[$language->code]['name']); ?>" />
                        ...
                        <div class="control-group<?php echo form_detect_error('description', true); ?>">
                            ...
                            <div class="controls">
                                <div class="tabbable tabbable-custom">
                                    <ul class="nav nav-tabs">
                                        <?php foreach ($this->lang->get('translable') as $language): ?>
                                        <li<?php echo ($this->session->get('language')->id == $language->id ? ' class="active"' : null); ?>><a href="#tab_transportation_type_description_<?php echo $language->code; ?>" data-toggle="tab"><i class="icon-picture"></i> <?php echo $language->name; ?></a></li>
                                        <?php endforeach; ?>
                                    </ul>

                                    <div class="tab-content">
                                        <?php foreach ($this->lang->get('translable') as $language): ?>
                                        <div class="tab-pane<?php echo ($this->session->get('language')->id == $language->id ? ' active' : null); ?>" id="tab_transportation_type_description_<?php echo $language->code; ?>">
                                            <textarea name="description[<?php echo $language->code; ?>]" class="span12 m-wrap" rows="5"><?php echo set_value('description[' . $language->code . ']', $transportation_type[$language->code]['description']); ?></textarea>
                                ...
                                <?php else: ?>
                                    <select name="status[]" id="status" class="span6 select2" multiple>
                                        <?php foreach (config_item('status') as $index => $value): ?>
                                            <option value="<?php echo $index; ?>"<?php echo ($index & $transportation_type['status'] ? ' selected' : ''); ?>><?php echo $value; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                <?php endif; ?>
